                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <h2 class="card-title">Inventario Web</h2>

                                <p class="card-text">
                                    Proyecto realizado para llevar un control
                                    de productos, movimientos de inventario
                                    y stock.
                                </p>

                                <p class="card-text">
                                    Utilicé HTML, CSS, JavaScript, PHP y MySQL.
                                </p>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    Proyecto realizado en Unity donde trabajé
                                    con realidad aumentada para mostrar objetos
                                    digitales mediante la cámara.
                                </p>

                                <p class="card-text">
                                    Utilicé Unity, C# y Vuforia.
                                </p>
